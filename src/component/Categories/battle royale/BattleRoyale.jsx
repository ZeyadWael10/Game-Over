...
export default function BattleRoyale() {
  let [battleRoyaleArr, setBattleRoyaleArr] = useState([])
...
axios.request(options).then(function (response) {
	setBattleRoyaleArr(response.data);
    ...
    return (
      ...
      <div className="row gy-2">
        {battleRoyaleArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
