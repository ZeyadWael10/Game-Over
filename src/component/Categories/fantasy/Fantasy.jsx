...
export default function Fantasy() {
  let [fantasyArr, setFantasyArr] = useState([])
...
axios.request(options).then(function (response) {
    ...
    return (
      ...
      <div className="row gy-2">
        {fantasyArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
