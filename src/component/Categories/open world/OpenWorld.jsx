...
export default function OpenWorld() {
  let [OpenWorldArr, setOpenWorldArr] = useState([])
...
axios.request(options).then(function (response) {
    ...
    return (
      ...
      <div className="row gy-2">
        {OpenWorldArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
