...
export default function Shooter() {
  let [shootingArr, setShootingArr] = useState([])
    async function getShootingGames() {
const options = {
  method: 'GET',
...
axios.request(options).then(function (response) {
    ...
    return (
      ...
      <div className="row gy-2">
        {shootingArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
