...
export default function Zombie() {
  let [zombieArr, setZombieArr] = useState([])
    async function getZombiesGames() {
const options = {
  method: 'GET',
...
axios.request(options).then(function (response) {
    ...
    return (
      ...
      <div className="row gy-2">
        {zombieArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
