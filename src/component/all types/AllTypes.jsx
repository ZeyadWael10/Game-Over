...
import style from "./Alltypes.modules.css"

export default function AllTypes() {
  let [gamesArr, setGamesArr] = useState([])
  async function getAllGamesTypes() {
    const options = {
      method: 'GET',
  ...
  <div className='container'>
      <div className="row gy-2">
        {gamesArr.map((item,index)=><div key={index} className={`${style.hover} col-sm-12 col-md-6 col-lg-4 col-xl-3`}>
