...
export default function Alphabetical() {
    let [alphabeticalArr, setAlphabeticalArr] = useState([])
    async function getAlphabetGames() {
const options = {
  method: 'GET',
...
axios.request(options).then(function (response) {
    setAlphabeticalArr(response.data)
...
useEffect(() => {
  ...
  return (
    ...
    <div className="row gy-2">
      {alphabeticalArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
