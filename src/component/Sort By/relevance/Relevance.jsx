...
export default function Relevance() {
  let [relevanceArr, setRelevanceArr] = useState([])
  ...
  return (
    ...
    <div className="row gy-2">
      {relevanceArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
