...
import style from "./releasedate.module.css"

export default function Releasedate() {
    let [releaseDateArr, setReleaseDateArr] = useState([])
...
axios.request(options).then(function (response) {
    setReleaseDateArr(response.data)
...
useEffect(() => {
  ...
  return (
    ...
    <div className="row gy-2">
      {releaseDateArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
