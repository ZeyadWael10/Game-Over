...
export default function Browser() {
  let [browserGamesArr, setBrowserGamesArr] = useState([])
  async function getPcGames() {
    ...
    axios.request(options).then(function (response) {
      setBrowserGamesArr(response.data)
  ...
  return (
    ...
    <div className="row gy-2">
      {browserGamesArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            ...
            <div className="card-body">
              ...
              <div className="icons d-flex align-items-center justify-content-between">
                ...
                <div className="right-icons pt-2">
                  ...
                  <i class="fa-solid text-white-50 fa-window-maximize"></i>
                </div>
              </div>
            </div>
        </div>
