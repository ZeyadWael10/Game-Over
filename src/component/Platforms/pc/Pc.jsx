...
export default function Pc() {
  let [pcGamesArr, setPcGamesArr] = useState([])
  ...
  return (
   <div className="container">
    <div className="row gy-2">
      {pcGamesArr.map((item,index)=><div key={index} className="col-sm-12 col-md-6 col-lg-4 col-xl-3">
